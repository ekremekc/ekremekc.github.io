...
We believe that most of the static engineering problems can be tackled by changing two main system features; geometry and/or material. We aim to be expert for the former and we collaborate for the latter. By combining these two, we aim to propose scientific, well-grounded understandings using [open source software (OSS)](https://en.wikipedia.org/wiki/Open-source_software). With the static behaviour well-studied, we then further explore dynamic effects of the operating parameters on the system, incorporate their effects, and optimize for the given objective. We always prioritize physical intelligence over artificial intelligence. This approach is worked well so far for
...
I have also created [a set of Jupyter notebooks](https://github.com/academicpages/academicpages.github.io/tree/master/useful_generator
...
For more info
------
More info about configuring Academic Pages can be found in [the guide](https://academicpages.github.io/useful/). The [guides for the Minimal Mistakes theme](https://mmistakes.github.io/minimal-mistakes/docs/configuration/) (which this theme was forked from) might also be helpful. -->