...
We believe that most of the static engineering problems can be tackled by changing two main system features; geometry and/or material. We aim to be expert for the former and we collaborate for the latter. By combining these two, we aim to propose scientific, well-grounded understandings using [open source software (OSS)](https://en.wikipedia.org/wiki/Open-source_software). With the static behaviour well-studied, we then further explore dynamic effects of the operating parameters on the system, incorporate their effects, and optimize for the given objective. This approach is worked well so far for
